...
/**
 * create_buffer - function allocate 1024 bytes for the buffer.
...
/**
 * main - function copies the contents of file to another.
 * @argc: num of arguments provided to the program.
 ...
 * If file_to can'tt be created or written to - exit code 99.
